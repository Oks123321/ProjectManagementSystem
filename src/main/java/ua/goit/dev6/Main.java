...
import ua.goit.dev6.command.*;
import ua.goit.dev6.config.DatabaseManagerConnector;
import ua.goit.dev6.config.PropertiesConfig;
import ua.goit.dev6.controller.ProjectManagementSystem;
import ua.goit.dev6.repository.*;
import ua.goit.dev6.service.*;
import ua.goit.dev6.service.converter.*;
import ua.goit.dev6.view.Console;
...
public class Main {
    public static void main(String[] args) {
        ...
        commands.add(new SkillCommands(view, skillService));
